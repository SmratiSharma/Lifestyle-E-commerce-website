...
<body>
    ...
    <div class="container1">
        <div class="container2">
            ...
            <p>We have the best Watches for you. No need to hunt around, we
                have all in one place.</p>
        </div>
    </div>
    <div class="Row">
        <div class=" one">
            <img src="manWatch11.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.30000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 1">
                <input type="hidden" name="Price" value="30000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch12.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
            ...
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 2">
                <input type="hidden" name="Price" value="40000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch1.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.40000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 3">
                <input type="hidden" name="Price" value="40000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch2.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
            ...
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 4">
    ...
    <div class="Row">
        <div class=" one">
            <img src="manWatch3.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.30000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 5">
                <input type="hidden" name="Price" value="30000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch4.jpg" alt="Responsive image">
            <div class="two">
                <h3>MMen Premium Watch</h3>
                <p>Price:Rs.40000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 6">
                <input type="hidden" name="Price" value="40000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch5.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.40000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 7">
                <input type="hidden" name="Price" value="40000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch6.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.80000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 8">
                <input type="hidden" name="Price" value="80000">
            </form>
        </div>
    ...
    <div class="Row">
        <div class=" one">
            <img src="manWatch7.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.30000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 9">
                <input type="hidden" name="Price" value="30000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch8.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.40000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 10">
                <input type="hidden" name="Price" value="40000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch9.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.40000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 11">
                <input type="hidden" name="Price" value="40000">
            </form>
        </div>
        <div class=" one">
            <img src="manWatch10.jpg" alt="Responsive image">
            <div class="two">
                <h3>Men Premium Watch</h3>
                <p>Price:Rs.80000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Man Watches 12">
                <input type="hidden" name="Price" value="80000">
            </form>
        </div>
