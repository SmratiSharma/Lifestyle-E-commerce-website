...
<body>
    ...
    <div class="container1">
        <div class="container2">
            ...
            <p>We have the best shirts for you. No need to hunt around, we
                have all in one place.</p>
        </div>
    </div>
    <div class="Row">
        <div class=" one">
            <img src="shirt1.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.3000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 1">
                <input type="hidden" name="Price" value="3000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt2.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
            ...
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 2">
                <input type="hidden" name="Price" value="4000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt3.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.4000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 3">
                <input type="hidden" name="Price" value="4000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt4.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
            ...
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 4">
    ...
    <div class="Row">
        <div class=" one">
            <img src="shirt5.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.3000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 5">
                <input type="hidden" name="Price" value="3000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt6.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.4000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 6">
                <input type="hidden" name="Price" value="4000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt7.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.4000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 7">
                <input type="hidden" name="Price" value="4000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt8.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.8000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 8">
                <input type="hidden" name="Price" value="8000">
            </form>
        </div>
    ...
    <div class="Row">
        <div class=" one">
            <img src="shirt9.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.3000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 9">
                <input type="hidden" name="Price" value="3000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt10.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.4000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 10">
                <input type="hidden" name="Price" value="4000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt11.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.4000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 11">
                <input type="hidden" name="Price" value="4000">
            </form>
        </div>
        <div class=" one">
            <img src="shirt12.jpeg" alt="Responsive image">
            <div class="two">
                <h3>Men Regular Fit Printed Formal Shirt</h3>
                <p>Price:Rs.8000.00</p>
            </div>
            <form action="manage_Cart.php" method="post">
                <button type="submit" name="Add" class="button">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Men Regular Fit Printed Formal Shirt 12">
                <input type="hidden" name="Price" value="8000">
            </form>
        </div>
